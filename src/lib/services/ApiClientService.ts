/**
 * ApiClientService - Camada de serviço para comunicação com a API
 * 
 * Este serviço fornece uma interface para os componentes de UI 
 * realizarem operações no backend através de chamadas HTTP.
 * 
 * Responsabilidades:
 * - Encapsular chamadas à API REST
 * - Determinar URLs base conforme o ambiente (servidor/cliente)
 * - Tratamento de erros de comunicação
 * - Conversão de dados para o formato JSON
 * 
 * Este serviço deve ser usado pelos componentes de UI e não
